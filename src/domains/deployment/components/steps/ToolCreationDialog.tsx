...
import { ParametersSection } from "./ToolCreationDialog/ParametersSection";

// Helper function to get an icon based on the parameter type
export const getParameterIcon = (type: string) => {
  switch (type) {
    case 'string':
            ...
            <div className="grid grid-cols-2 gap-2  h-[50vh] overflow-y-auto px-2 mx-1">
              ...
              <div className="col-span-2">
                <ParametersSection
                  ...
                  onUpdateParameter={(pIdx, param) => updateParameter(pIdx, param)}
